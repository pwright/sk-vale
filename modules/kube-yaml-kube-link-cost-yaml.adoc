...
*📌 NOTE*
For most load-balancing and failover use cases, a xref:kube-creating-multikeylistener-yaml[multi-key listener]
...
xref:kube-creating-multikeylistener-yaml[multi-key listener] instead.
