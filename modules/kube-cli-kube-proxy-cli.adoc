...
For information about linking sites using custom certificates instead of the default Skupper-generated certificates, see xref:../kube-yaml/custom-certs.adoc[Linking sites using custom certificates].
