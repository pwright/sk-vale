...
image::../images/one-cluster.svg[one-cluster]
...
image::../images/two-clusters.svg[two-clusters]
...
image::../images/five-clusters.svg[five-clusters]
...
image::../images/many-clusters.svg[many-clusters]
